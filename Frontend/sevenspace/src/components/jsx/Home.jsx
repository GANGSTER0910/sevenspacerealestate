...
export default function Home() {
  ...
  useEffect(() => {
    const fetchProperties = async () => {
      try {
        const response = await axios.get("https://your-api-url.com/properties");  // Replace with actual API endpoint
        ...
        setError("There was an issue loading properties.");  // Set error message
